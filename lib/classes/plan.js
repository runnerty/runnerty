...
class Plan {
  ...
  startChain(chainId, inputValues, customValues, noWait){
    let _this = this;
    return new Promise(async (resolve, reject) => {
      let chain = _this.getChainById(chainId);
  ...
  loadChainToPlan(newChain) {
    ...
    const indexChain = _this.getIndexChainById(chainId);
