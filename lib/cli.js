...
class Cli {
  ...
  setOptions() {
    ...
    program
      ...
      .option('-f, --force_chain_exec <chainId>', 'Force chain execution (For development tests). It is possible to set a list of comma separated items')
      ...
      .option('-n, --namespace <namespace>', 'Enable the chains of the indicated namespace. It is possible to set a list of comma separated items')
      .option('-N, --namespace <namespace>', 'Enable the chains of the indicated namespace. It is possible to set a list of comma separated items')
      .option('--namespace <namespace>', 'Enable the chains of the indicated namespace. It is possible to set a list of comma separated items');
