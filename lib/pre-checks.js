...
const errorMsg = chalk.hex('#fee84a')(`Runnerty ${runnertyVersion}\n requires a Node version ${engineRequired} (current ${localNodeVersion})`);

const msgErrorFormated = boxen(`${errorTitle}\n\n${errorMsg}`, {padding: 1, margin: 1, align:'center', borderStyle: 'double', borderColor:'#50bf5a', backgroundColor: '#192241'});
