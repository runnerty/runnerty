...
function getObjsCustomDates(text){
  ...
  return new Promise(async (resolve) => {
    ...
    var yearsInc = text.toString().match(/\:YYYY_[-,+]?[0-9]{1,2}(?!_)\b/ig);

    if (yearsInc) {
      var yearsIncLength = yearsInc.length;
    ...
    // YEARS YY_[INCREMENT]
    var shortYearsInc = text.toString().match(/\:YY_[-,+]?[0-9]{1,2}(?!_)\b/ig);

    if (shortYearsInc) {
      var shortYearsIncLength = shortYearsInc.length;
    ...
    // MONTHS MMMM_[LANG]
    var months = text.toString().match(/\:MMMM_[a-zA-Z]{2}/ig);
    ...
    var monthsInc = text.toString().match(/\:MMMM_[-,+]?[0-9]{1,2}(?!_)\b/ig);
    ...
    var shortMonths = text.toString().match(/\:MMM_[a-zA-Z]{2}/ig);
    ...
    // DAYS DDDD_[LANG]
    var days = text.toString().match(/\:DDDD_[a-zA-Z]{2}/ig);
    ...
    var daysInc = text.toString().match(/\:DDDD_[-,+]?[0-9]{1,2}(?!_)\b/ig);

    if (daysInc) {
      var daysIncLength = daysInc.length;
    ...
    var shortDays = text.toString().match(/\:DDD_[a-zA-Z]{2}/ig);
    ...
    // DAYS DDD_[INCREMENT]
    var shortDaysInc = text.toString().match(/\:DDD_[-,+]?[0-9]{1,2}(?!_)\b/ig);

    if (shortDaysInc) {
      var shortDaysIncLength = shortDaysInc.length;
